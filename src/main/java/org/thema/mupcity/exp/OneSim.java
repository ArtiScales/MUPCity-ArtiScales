...
public class OneSim {
	...
	public static void main(String[] args) throws IOException, SchemaException {
		 ...
		 */
		File folderData = new File("/home/mcolomb/informatique/MUP/explo/data/");
		File dir = new File("/media/mcolomb/Data_2/resultTest/OneTest/result/"); // définition des variables fixes
		String name = "OneTest";
		dir.mkdirs();
