...
public class ExplorationTest {
		...
		File roadFile = new File("/home/mcolomb/informatique/MUP/explo/data/route_sans_chemin.shp");
		File facilityFile = new File("/home/mcolomb/informatique/MUP/explo/data/CS_au_besac_sirene_2012.shp");
		File leisureFile = new File("/home/mcolomb/informatique/MUP/explo/data/loisirs.shp");
						...
						for (long seed=1; seed<=3;seed++)
					        ...
					        if (memedos){
					        	testFile = dirgrid;
					        	 ...
					        	 testFile = new File("/home/mcolomb/informatique/MUP/explo/result/testExplo/"+g+"/"+nMax+"/"+titre);
					        	}
